...
# Download script
Download script to make your existing install 64-bit:<br> `wget https://raw.githubusercontent.com/mobilegmYT/64-bitify/master/64-bitify.sh && chmod +x 64-bitify.sh`
