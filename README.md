...
Thanks to a German toad that swears and the Supreme team for the code to enable and disable 64-bit. Thanks to the Pi Labs devs for the original Twister OS image.
