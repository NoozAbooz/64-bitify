...
select opt in "${options[@]}" "Quit to shell"; do 
    ...
    5 ) rm 64-bitify.sh && wget https://raw.githubusercontent.com/mobilegmYT/64-bitify/master/64-bitify.sh && chmod +x 64-bitify.sh && break;; 
